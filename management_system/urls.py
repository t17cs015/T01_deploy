...
from .views import RequestAddView , RequestMainView ,RequestPerformanceView , RequestLoginView ,RequestAddCheckView
...
urlpatterns = [
    ...
    path('addCheck/',RequestAddCheckView.as_view(),name='addCheck'),
